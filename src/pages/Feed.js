            ...
            <div className='flex item-center justify-center '>
                <div role="none" className="sm:w-auto md:w-[70vw]lg:w-[40vw] xl:w-[70vw] border-2 border-primaryBorder group bg-gray-gray1 border-b border-primaryBorder px-4 sm:px-6 py-4 hover:cursor-pointer w-[calc(100%-1px)]">
                    ...
                    <div className='flex flexWrap item-center justify-between'>
                        <div ml-2 className="w-[30vw] flex items-center justify-center gWhite border border-primaryBorder rounded-[56px] p-2 group-hover:shadow-[0px_4px_16px_rgba(33,33,33,0.15)] transition" onClick={() => { setPostModal(true) }}>
                        ...
                        <div className="w-[30vw] flex items-center justify-center bg-gray border border-primaryBorder rounded-[56px] p-2 group-hover:shadow-[0px_4px_16px_rgba(33,33,33,0.15)] transition">
                                        ...
                                        <a className="flex items-center" href="/yogini">
                                            ...
                                            <div className="ml-2">
                                                ...
                                                <div className="textLight text-xs leading-4">
                                                    <p><span>#show</span> • <span className="text-xs textLight">1h</span></p>
                                                </div>
                                            </div>
                                        </a>
                                    </span>
