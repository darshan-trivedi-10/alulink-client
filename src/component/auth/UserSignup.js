                ...
                <form onSubmit={registerUser}>
                    ...
                    <div className="flex flex-col space-between mb-6 space-y-6 md:flex-row md:space-y-0 md:space-x-6">
                        ...
                        <div className="mb-6 w-full">
                            ...
                            <input value={formData.password} onChange={handleChange} type="text" id="password" className="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
                        </div>
